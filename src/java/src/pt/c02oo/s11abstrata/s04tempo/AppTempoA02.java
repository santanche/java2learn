package pt.c02oo.s11abstrata.s04tempo;

public class AppTempoA02
{
    public static void main(String argumentos[])
    {
        ...
        if (argumentos.length < 4)
            ...
            if (oTempo == null)
                ...
                int comparacao = oTempo.compara(oTempo2);
                if (comparacao == 0)
                    System.out.println("Tempos iguais");
                else if (comparacao == 1)
                    System.out.println("Tempo 1 maior que Tempo 2");
                else
                    System.out.println("Tempo 2 maior que Tempo 1");
            }
        }
    }
}
