 ...
 * problema de interferencia corrigido com metodo synchronized.
 * 
 * @author Andre Santanche
 *
 */
public class Ex02ContaCerta extends Thread
{
    public class Contador
    {
        ...
        public synchronized void atualiza(int quantidade)
        {
            int x = valor;
    ...
    {
        Ex02ContaCerta contaCerta = new Ex02ContaCerta();
