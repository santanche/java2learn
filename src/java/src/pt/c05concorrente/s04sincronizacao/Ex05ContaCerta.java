 ...
 * transferencia bem sucedida do synchronized para clientes
 * (MultiplasContagens) -- solucao: synchronized aponta para
 * o mesmo objeto.
 * 
 * @author Andre Santanche
 *
 */
public class Ex05ContaCerta extends Thread
{
    ...
    {
        Ex05ContaCerta contaCerta = new Ex05ContaCerta();
