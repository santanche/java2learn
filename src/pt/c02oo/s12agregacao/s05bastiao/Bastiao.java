...
public class Bastiao
{
    ...
    public void penteia()
    {
        mudaCaracteristica(TOPETE, "topete", "penteado");
        aparece();
    }
    ...
    public void mudaCaracteristica(int indiceParte,
                                   String caracteristica, String valor)
    {
        if (partesCorpo[indiceParte] instanceof ParteCustomizavel)
            ((ParteCustomizavel)partesCorpo[indiceParte]).
                mudaCaracteristica(caracteristica, valor);
    }
}
